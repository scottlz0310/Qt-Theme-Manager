...
- 🎨 **高度なテーマエディター**: 色彩理論に基づく設計ツールとリアルタイムプレビュー
- 🖥️ **pipからのGUIツール**: `theme-editor` と `theme-preview` コマンド
- 🎯 **カスタマイズ強化**: コンポーネント別設定とアクセシビリティ機能
- 📱 **統合改善**: 改良されたAPIとドキュメント
...
```bash
# インストールしてテーマエディターを起動（v0.2.0の新機能！）
