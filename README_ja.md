...
### 🦓 新機能: ゼブラパターン自動生成
- **リアルタイムコントラスト調整**: スライダーと直接入力でのコントラスト比調整（1.15:1から1.80:1）
- **WCAG 2.1準拠**: HSL/HSV色空間での科学的色計算
- **3段階アクセシビリティレベル**: 控えめ（1.15:1）、中程度（1.30:1）、高（1.80:1）コントラスト
- **マルチプラットフォーム対応**: PyQt5/PyQt6/PySide6クロスフレームワーク互換性
- **統合テーマエディター**: ライブプレビュー付きゼブラタブを追加
- **スタンドアロンモード**: 専用ゼブラパターンエディターで集中的な色作業
