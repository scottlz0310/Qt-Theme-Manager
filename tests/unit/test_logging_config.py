...
class TestLoggingConfig(unittest.TestCase):
    ...
    def test_setup_file_handler_directory_creation(self) -> None:
        ...
        sample_config = {
            ...
            'loggers': {'qt_theme_manager': {'level': 'INFO', 'handlers': ['console', 'file']}},
    ...
    def test_set_log_level_invalid(self) -> None:
        ...
        self.assertEqual(
            config['loggers']['qt_theme_manager']['level'], 'WARNING'
        )
    ...
    def test_disable_file_logging(self) -> None:
        ...
        self.assertIn('file', config['handlers'])
        self.assertIn(
            'file', config['loggers']['qt_theme_manager']['handlers']
        )
    ...
    def test_disable_file_logging_no_file_handler(self) -> None:
        ...
        config = {'version': 1, 'formatters': {}, 'handlers': {}, 'loggers': {}, 'root': {}}
