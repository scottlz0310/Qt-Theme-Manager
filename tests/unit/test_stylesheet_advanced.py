...
class TestStylesheetAdvanced(unittest.TestCase):
    ...
    def test_svg_icon_integration(self) -> None:
        ...
        self.assertIn(
            "PHN2ZyB3aWR0aD0iMTIiIGhlaWdodD0iMTIiIHZpZXdCb3g9IjAgMCAxMiAxMiIg", qss
        )
    ...
    def test_advanced_mode_customization(self) -> None:
        ...
        custom_config["custom_component"] = {"background": "#ff0000", "text": "#ffffff"}
